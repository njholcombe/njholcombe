...
-  aws-celltower-pipeline repository (private): batch job for the datalake (EventBridge, Step Functions, Lambda, S3, Athena), SageMaker consumes gold data, learns patterns, and produces ML artifacts related to outliers, coverage modeling, and tower stability over time)
