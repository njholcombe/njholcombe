...
-  aws-celltower-pipeline repository (private): resuable monthly batch job for the datalake (EventBridge, Step Functions, Lambda, S3, Athena), SageMaker consumes gold data, learns patterns, and produces ML artifacts related to outliers, coverage modeling, and tower stability over time)
-  fcc-asr-pipeline repository (private):resuable monthly batch job for the datalake (eventbridge, stepfunctions, lambda, s3, and Athena for silver data layer)
